...
const Socials = () => {
  return (
    <div className='flex grid-flow-col gap-4 md:place-self-center md:justify-self-end'>
      <Link href='https://twitter.com/_tequ_' target='_blank'>
...
export const Footer = () => {
  return (
    <footer className='footer grid grid-cols-12 items-center justify-between gap-y-2 bg-base-200 p-4 px-12 pb-[calc(env(safe-area-inset-bottom)+6rem)] text-base-content md:flex md:pb-4'>
