...
const Socials = () => {
  ...
  return (
    <div className='flex grid-flow-col gap-2 md:place-self-center md:justify-self-end'>
      <button className='btn-ghost btn' onClick={() => openLink('https://github.com/lathanbritz/XRPSwap')}>
      ...
      <button className='btn-ghost btn' onClick={() => openLink('https://support.panicbot.app/xrpswap')}>
